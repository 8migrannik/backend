...
namespace System.Runtime.CompilerServices // to allow init; idk why, bug!
{
...
namespace ScrumBoardLibrary
{
    public class Board
    {
        ...
        {
            if (this._columns.Count < MaxCapacity)
            {
        ...
        public void MoveTask(string taskName, Column columnFrom, Column columnTo, int newPriority)
        {
